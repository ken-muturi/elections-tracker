    ...
    <VStack gap={6} alignItems="stretch" w="full">
      ...
      <VStack gap={4} alignItems="stretch">
        {sortedPositions.map((position) => {
          ...
          return (
            <Box key={position.id} bg="white" borderRadius="2xl" borderWidth="1px" borderColor="gray.100"
                ...
                <HStack justify="space-between" flexWrap="wrap" gap={2}>
                  <HStack gap={3}>
                    ...
                    <VStack alignItems="flex-start" gap={0}>
                      ...
                      <Text fontSize="xs" color="gray.500">{position.candidates.length} candidates</Text>
                    </VStack>
                  </HStack>
