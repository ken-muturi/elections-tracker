...
export default function PositionResults({ results }: PositionResultsProps) {
                    ...
                    <Box px={6} py={2.5} bg="gray.50" borderBottomWidth="1px" borderBottomColor="gray.100">
                      <HStack justify="space-between">
                        <HStack gap={2}>
                          ...
                          <Text
                            fontSize="xs" fontWeight="700" color="gray.700"
                          ...
                          >
                            <HStack gap={4} align="center">
                              ...
                              <Box flex={1} minW={0}>
                                  ...
                                  <HStack gap={2} flexShrink={0}>
                                    ...
                                    {entityTotal > 0 && (
                                      <Text
                                        ...
                                        w="36px" textAlign="right"
                                      >
                                        {(
                                          (candidate.streamVotes / entityTotal) *
                                          100
                                        ).toFixed(1)}
                                        %
                                      </Text>
                                ...
                                <Box
                                  h="4px" bg="gray.100" borderRadius="full"
                                  overflow="hidden"
                                >
                                  <Box
                                    h="full"
